...
})({"avl7g":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d45c5344cee16744";
"use strict";
...
},{}],"h2PEg":[function(require,module,exports) {
...
const advDataDecode = (data)=>{
    ...
    let dt = new Date();
    let currentTs = dt.getFullYear() + "/" + (dt.getMonth() + 1).toString().padStart(2, "0") + "/" + dt.getDate().toString().padStart(2, "0") + " " + dt.getHours().toString().padStart(2, "0") + ":" + dt.getMinutes().toString().padStart(2, "0") + ":" + dt.getSeconds().toString().padStart(2, "0");
    let tempHex = parseInt("0x" + data.substr(pos + 22, 4).match(/../g).reverse().join("")) //temperature cal
    ;
    if (tempHex > 1000) tempHex = (tempHex - 65536) / 10;
...
const repeatfunc = ()=>{
    _bleuio.at_findscandata("5B07050960FDED", 6).then((x)=>{
...
},{}]},["avl7g","h2PEg"], "h2PEg", "parcelRequire94c2")

//# sourceMappingURL=index.cee16744.js.map
